...
echo 'DOMAIN_URL=https://83.217.69.213//backend' >> .env
...
echo "I_LEARN_TOOL_LAUNCH_URI = 'https://83.217.69.213/'" >> .env
echo "I_LEARN_REDIRECT_URI = 'https://83.217.69.213//backend/api/learningObject/getWrapped'" >> .env
